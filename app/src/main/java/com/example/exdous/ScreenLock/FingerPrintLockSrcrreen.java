package com.example.exdous.ScreenLock;
...
public class FingerPrintLockSrcrreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finger_print_lock_srcrreen);
